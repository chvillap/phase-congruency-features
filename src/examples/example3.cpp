...
int main(int argc, char *argv[])
{
    ...
    try {
        bip::triple<size_t> size = {181, 217, 181};
        ...
        // Apply the phase congruency technique to detect edges, corners and
        // other features in the 3D input image.
        bip::phase_congruency pc(
            "brainweb",  // Filename prefix.
            image,       // Input image.
